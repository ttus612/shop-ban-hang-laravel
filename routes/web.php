...
Route::get('/dash-board', 'App\Http\Controllers\AdminController@show_dashboard');
Route::post('/admin-dashbord', 'App\Http\Controllers\AdminController@dashboard');
...
Route::get('/delete-to-cart/{cart_id}', 'App\Http\Controllers\CartController@delete_cart');
