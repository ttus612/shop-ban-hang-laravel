...
<head>
    ...
    <meta property="og:site_name" content="http://localhost/shopbanhang-laravel/" />
...
<body>
                    ...
                    <div class="col-sm-4">
                        <form action="{{URL::to('/tim-kiem')}}" method="POST">
                            ...
                            <div class="search_box pull-right">
                                ...
                                <input type="submit" name="search_items" style="margin-top: 0px; color: black;" class="btn btn-primary btn-sm" value="Tìm kiếm"/>
    ...
    <script src="{{asset('public/frontend/js/main.js')}}"></script>
     <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v17.0" nonce="nBsKuObQ"></script>
</html>